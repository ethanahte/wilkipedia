...
const ROWS = {
  ...
  'Calendar': ['Calendario', 'Lịch', '日历', '行事曆', '일정', 'カレンダー', 'Kalendaryo', 'कैलेंडर', 'ਕੈਲੰਡਰ', 'క్యాలెండర్', 'நாட்காட்டி', 'التقويم', 'تقویم', 'Календарь', 'Calendário'],
  ...
  'The student guide to Wilcox classes': ['La guía estudiantil de las clases de Wilcox', 'Cẩm nang của học sinh về các lớp học ở Wilcox', 'Wilcox 课程学生指南', 'Wilcox 課程學生指南', '학생이 만든 Wilcox 수업 가이드', '生徒がつくるWilcoxの授業ガイド', 'Gabay ng mga estudyante sa mga klase sa Wilcox', 'Wilcox की कक्षाओं के लिए छात्रों की गाइड', 'Wilcox ਦੀਆਂ ਕਲਾਸਾਂ ਲਈ ਵਿਦਿਆਰਥੀਆਂ ਦੀ ਗਾਈਡ', 'Wilcox తరగతులకు విద్యార్థుల గైడ్', 'Wilcox வகுப்புகளுக்கான மாணவர் வழிகாட்டி', 'دليل الطلاب لمواد Wilcox', 'راهنمای دانش‌آموزی کلاس‌های Wilcox', 'Гид по предметам Wilcox от учеников', 'O guia dos alunos para as disciplinas da Wilcox'],
  'Everything Wilcox, in one place.': ['Todo sobre Wilcox, en un solo lugar.', 'Mọi thứ về Wilcox, ở cùng một nơi.', '关于 Wilcox 的一切，尽在一处。', '關於 Wilcox 的一切，盡在一處。', 'Wilcox의 모든 것을 한곳에서.', 'Wilcoxのすべてを、ひとつの場所に。', 'Lahat tungkol sa Wilcox, nasa iisang lugar.', 'Wilcox के बारे में सब कुछ, एक ही जगह।', 'Wilcox ਬਾਰੇ ਸਭ ਕੁਝ, ਇੱਕੋ ਥਾਂ।', 'Wilcox గురించి అన్నీ, ఒకే చోట.', 'Wilcox பற்றிய அனைத்தும், ஒரே இடத்தில்.', 'كل ما يخص Wilcox في مكان واحد.', 'همه‌چیز دربارهٔ Wilcox، در یک جا.', 'Всё о Wilcox — в одном месте.', 'Tudo sobre a Wilcox, em um só lugar.'],
  'Know a class before you take it.': ['Conoce una clase antes de tomarla.', 'Hiểu rõ một lớp học trước khi đăng ký.', '选课之前，先了解这门课。', '選課之前，先了解這門課。', '수강하기 전에 수업을 미리 알아보세요.', '履修する前に、授業を知ろう。', 'Kilalanin ang isang klase bago mo ito kunin.', 'कोई कक्षा लेने से पहले उसे जान लें।', 'ਕੋਈ ਕਲਾਸ ਲੈਣ ਤੋਂ ਪਹਿਲਾਂ ਉਸਨੂੰ ਜਾਣ ਲਓ।', 'ఏ తరగతి తీసుకునే ముందు దాని గురించి తెలుసుకోండి.', 'ஒரு வகுப்பில் சேரும் முன் அதைப் பற்றித் தெரிந்துகொள்ளுங்கள்.', 'تعرّف على المادة قبل أن تسجّل فيها.', 'پیش از برداشتن یک درس، آن را بشناسید.', 'Узнайте о предмете, прежде чем его выбрать.', 'Conheça uma disciplina antes de cursá-la.'],
  'What each class page tells you': ['Lo que te dice cada página de clase', 'Mỗi trang lớp học cho bạn biết gì', '每个课程页面告诉你什么', '每個課程頁面告訴你什麼', '각 수업 페이지에서 알 수 있는 것', '各授業ページでわかること', 'Ano ang sinasabi sa iyo ng bawat pahina ng klase', 'हर कक्षा पेज आपको क्या बताता है', 'ਹਰ ਕਲਾਸ ਪੰਨਾ ਤੁਹਾਨੂੰ ਕੀ ਦੱਸਦਾ ਹੈ', 'ప్రతి తరగతి పేజీ మీకు ఏం చెబుతుంది', 'ஒவ்வொரு வகுப்புப் பக்கமும் உங்களுக்குச் சொல்வது', 'ما تخبرك به صفحة كل مادة', 'هر صفحهٔ کلاس چه چیزهایی به شما می‌گوید', 'Что рассказывает страница каждого предмета', 'O que a página de cada disciplina mostra'],
