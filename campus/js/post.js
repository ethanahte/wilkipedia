...
//   pixel:   the other style (like the game Summerhouse). The pixels live on
//            the surfaces (toon.js paints a world-space pixel grid), so here
//            it only means a firmer, darker outline and no tilt-shift or beams.
...
export class Post {
  ...
  setPixel(on) { this.pixel = !!on; this.comp.uniforms.pixel.value = this.pixel ? 1 : 0; }
